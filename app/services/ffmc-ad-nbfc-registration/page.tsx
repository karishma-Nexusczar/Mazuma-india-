        ...
        <section className="ffmc-services-section">
          <div className="ffmc-container">
            ...
            <div className="ffmc-services-grid">
              ...
              >
                <div className="ffmc-service-card-top-bar" />
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/ffmc-registration.jpg"
              ...
              >
                ...
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/ad-category-ii.jpg"
              ...
              >
                ...
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/nbfc-registration.jpg"
              ...
              {/* Card 4 */}
              <div
                className={`ffmc-service-card ${!showAllFfmcServices ? "ffmc-service-hide-mobile" : ""}`}
                onClick={() => setIsModalOpen(true)}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
              ...
              >
                ...
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/rbi-application.jpg"
              ...
              >
                ...
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/regulatory-compliance.jpg"
              ...
              >
                ...
                <div className="ffmc-service-icon-wrapper">
                  <img
                    src="/images/icons/financial-advisory.jpg"
            ...
            <div className="ffmc-timeline-wrapper">
              ...
              <div className="ffmc-timeline-grid-6">
                ...
                <div className="ffmc-timeline-step-item">
                  <div className="ffmc-step-badge">
                    <div className="ffmc-step-icon-circle">
                      <Users size={20} style={{ color: "#FF6B1A" }} />
                    </div>
                  </div>
                ...
                <div className="ffmc-timeline-step-item">
                  <div className="ffmc-step-badge">
                    <div className="ffmc-step-icon-circle">
                      <ScaleIcon size={20} style={{ color: "#FF6B1A" }} />
                    </div>
                  </div>
                ...
                <div className="ffmc-timeline-step-item">
                  <div className="ffmc-step-badge">
                    <div className="ffmc-step-icon-circle">
                      <FileText size={20} style={{ color: "#FF6B1A" }} />
                    </div>
                  </div>
                ...
                <div className="ffmc-timeline-step-item">
                  <div className="ffmc-step-badge">
                    <div className="ffmc-step-icon-circle">
                      <Rocket size={20} style={{ color: "#FF6B1A" }} />
                    </div>
                  </div>
                ...
                <div className="ffmc-timeline-step-item">
                  <div className="ffmc-step-badge">
                    <div className="ffmc-step-icon-circle">
                      <Landmark size={20} style={{ color: "#FF6B1A" }} />
                    </div>
                  </div>
            ...
            <div className="ffmc-why-grid">
              ...
              <div className="ffmc-why-card">
                <div className="ffmc-why-icon-box">
                  <ShieldCheck size={22} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-why-card">
                <div className="ffmc-why-icon-box">
                  <FileText size={22} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-why-card">
                <div className="ffmc-why-icon-box">
                  <BadgeCheck size={22} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-why-card">
                <div className="ffmc-why-icon-box">
                  <Handshake size={22} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-why-card">
                <div className="ffmc-why-icon-box">
                  <Award size={22} style={{ color: "#FF6B1A" }} />
                </div>
                <h3 className="ffmc-why-card-title">Long-Term Compliance Support</h3>
                <p className="ffmc-why-card-desc">
                  Ongoing compliance and reporting support options.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="ffmc-support-grid">
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Coins size={20} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Building2 size={20} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Laptop size={20} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Percent size={20} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Globe2 size={20} style={{ color: "#FF6B1A" }} />
                </div>
              ...
              <div className="ffmc-support-card">
                <div className="ffmc-support-icon-box">
                  <Building size={20} style={{ color: "#FF6B1A" }} />
                </div>
        ...
        <section className="ffmc-beyond-section">
          <div className="ffmc-container">
            ...
            <div className="ffmc-beyond-grid">
              ...
              <div className="ffmc-beyond-card">
                <div className="ffmc-beyond-icon-wrapper">
                  <Briefcase size={22} style={{ color: "#FF6B1A" }} />
                </div>
